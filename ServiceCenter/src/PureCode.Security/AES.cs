...
namespace PureCode.Security
{
  public static class AES
  {
    ...
    public static string DecryptFromBase64(string data, byte[] key, byte[] iv, CipherMode cipherMode, PaddingMode paddingMode)
    {
      if (string.IsNullOrEmpty(data))
      {
        throw new ArgumentNullException(nameof(data));
    ...
    public static string EncryptToBase64(string data, byte[] key, byte[] iv, CipherMode cipherMode, PaddingMode paddingMode)
    {
      if (string.IsNullOrEmpty(data))
      {
        throw new ArgumentNullException(nameof(data));
