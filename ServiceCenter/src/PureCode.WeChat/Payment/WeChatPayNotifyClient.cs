...
using PureCode.WeChat.Payment.Parser;
using System;
using System.IO;
using System.Linq;
...
namespace PureCode.WeChat.Payment
{
  public class WeChatPayNotifyClient : IWeChatPayNotifyClient
  {
    ...
    #endregion WeChatPayNotifyClient Constructors
    ...
    private static WeChatPayHeaders GetWeChatPayHeadersFromRequest(HttpRequest request)
    {
    ...
    #endregion IWeChatPayNotifyClient Members
